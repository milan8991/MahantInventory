...
namespace MahantInv.Infrastructure.Data
{
    public class PartiesRepository : DapperRepository<Party>, IPartiesRepository
    {
        ...
        {
            return db.QuerySingleAsync<PartyVM>(@"select p.*,u.UserName LastModifiedBy from Parties p 
        ...
        {
            return db.QueryAsync<PartyVM>(@"select p.*,u.UserName LastModifiedBy from Parties p 
